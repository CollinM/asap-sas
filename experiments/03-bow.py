...
def make_pipeline(bow_min, trees, depth):
    pipe = Pipeline()
    # Preprocessing
    ...
    # ML
    pipe.add_phase(RandomForest(num_trees=trees, max_depth=depth, target="score1", features=["bow"]))
    return pipe
...
if __name__ == "__main__":
    ...
    for num_id, train_path, test_path in inputs:
        ...
        pipe = make_pipeline(args.bow_min_occur, args.num_trees, args.max_depth)
        print("Done")
