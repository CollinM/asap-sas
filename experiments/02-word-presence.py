...
from asap.core.features import Tokenizer, ContainsWords
...
def make_pipeline(words_path, trees, depth):
    ...
    # ML
    pipe.add_phase(RandomForest(num_trees=trees, max_depth=depth, target="score1", features=["word-presence"]))
    return pipe
