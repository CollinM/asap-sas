...
class RandomForest(Model):
    ...
    def __init__(self, model=None, num_trees=100, max_depth=None, **kwargs):
    ...
    def process(self, instance):
        ...
        instance.add_feature(self._prdxn_key, prdxn)
        return instance

    def train(self, instances):
        # Create model
        self._model = RandomForestClassifier(n_estimators=self._num_trees, max_depth=self._max_depth, n_jobs=7)
